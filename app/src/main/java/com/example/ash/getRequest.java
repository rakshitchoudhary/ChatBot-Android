...
public class getRequest {
    ...
    private String APIkey = "Your API Key"; // Create account on https://brainshop.ai/brain/ for APIKey and Brain Id
    private String brainID = "Your Brain Id";
                ...
                new Response.Listener<JSONObject>(){
                    ...
                    public void onResponse(JSONObject response){
                        try {
                            ...
                            Log.e("RESPONSE", reply + ", " + response.toString());
